...
};
{
    ...
    function validateComponentName(value) {
        return __awaiter(this, void 0, void 0, function* () {
            let valid = true;
            let errors = [];
            let checkRegexRes = yield checkRegex(regex, value, 'component_name');
            let checkMinLengthRes = yield checkMinLength(length.min, value, 'component_name');
            let checkMaxLengthRes = yield checkMaxLength(length.max, value, 'component_name');
