...
};
{
    ...
    function validateComponentDescription(value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let errors = [];
            if (value) {
                let checkRegexRes = yield checkRegex(regex, value, 'component_description');
                let checkMinLengthRes = yield checkMinLength(length.min, value, 'component_description');
                let checkMaxLengthRes = yield checkMaxLength(length.max, value, 'component_description');
