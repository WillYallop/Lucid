...
router.get('/page/:slug/:type/:post_name', jsonParser, CmsPageController.get_single_page); // Get single/multiple pages
router.get('/pages/:limit/:skip', jsonParser, CmsPageController.get_multiple_pages); // Get single/multiple pages
// Components
